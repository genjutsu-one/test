...
function getContext(channelId) {
    try {
        ...
        if (!msgs) return "";
        var arr = msgs._array || (msgs.toArray ? msgs.toArray() : []);        return arr.slice(-10).map(function (m) {
            var author = m.author || {};
...
async function askAI(query, channelId, history) {
    ...
    // URL согласно документации onlysq.ru
...
// --- Компоненты UI ---
// Иконка Sparkles (SVG Path)const SparklesIcon = ({ color = "#fff", size = 24 }) => React.createElement(
    RN.Image, 
    { 
...
function AIChatModal({ visible, onClose }) {
    ...
    const s = {
        ...
        sheet: { 
            ...
            maxHeight: "80%", minHeight: 400,             paddingHorizontal: 16, paddingTop: 12, paddingBottom: 20,
        ...
        React.createElement(Pressable, { style: s.overlay, onPress: onClose },
            React.createElement(Pressable, { style: s.sheet, onPress: (e) => e.stopPropagation() },
                ...
                React.createElement(ScrollView, { 
                    ...
                    showsVerticalScrollIndicator: false 
                     ...
                     history.length === 0 
                        ? React.createElement(View, {style: {alignItems: "center", marginTop: 40}},
                            React.createElement(SparklesIcon, {size: 48, color: "#4e5058"}),
                            React.createElement(Text, {style: {color: "#80848e", marginTop: 12}}, "Задайте вопрос...")
                          )
                        : history.map((m, i) => 
                    ...
                    loading && React.createElement(View, { style: [s.msgRow, s.bubbleAi] },                        React.createElement(Text, { style: [s.text, {opacity: 0.7}] }, "⏳ Думаю...")
                    )
                ),
